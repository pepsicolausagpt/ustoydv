...
const features = [
  {
    ...
    icon: 'M2 20h20M4 20v-7l10-4v4l10-4v7M10 20v-4h4v4'
  },
  {
    id: 'delivery',
    title: 'Попутная Доставка',
    desc: 'Доставляем пиломатериалы и сыпучие грузы собственными самосвалами по всему Хабаровску.',
    icon: 'M5 18H3a2 2 0 01-2-2V8a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2h-2m-9 0a2 2 0 104 0 2 2 0 00-4 0zm10 0a2 2 0 104 0 2 2 0 00-4 0zM17 9h4l2 3v6h-3a2 2 0 00-4 0h-2V9h3z'
  },
  {
    id: 'range',
